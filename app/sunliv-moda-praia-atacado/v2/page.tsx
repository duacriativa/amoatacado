            ...
            <section className="relative min-h-screen overflow-hidden">
                ...
                <div className="absolute top-0 left-0 right-0 z-20 px-6 py-5 flex items-center justify-between">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 border border-white/40 text-white text-[10px] font-bold uppercase tracking-widest px-4 py-2 rounded-full hover:bg-white/10 transition-colors backdrop-blur-sm"
                    >
