...
import { Instagram, MapPin, Truck, CheckCircle2, MessageCircle, X } from 'lucide-react';
        ...
        {!dismissed && (
          ...
          >
            <button
              ...
              aria-label="Fechar"
              style={{ position: 'absolute', top: 8, right: 8, background: 'none', border: 'none', color: 'rgba(10,10,10,0.35)', cursor: 'pointer', padding: 4, display: 'flex' }}
            >
              <X size={14} />
            </button>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
              <div style={{ width: 30, height: 30, borderRadius: '50%', background: ACCENT, display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontSize: 13, fontWeight: 700, flexShrink: 0 }}>T</div>
              <span style={{ fontSize: 13, fontWeight: 700, color: '#0a0a0a' }}>Thalya · Kyrefh</span>
            </div>
            <p style={{ fontSize: 13, lineHeight: 1.5, color: 'rgba(10,10,10,0.7)', margin: '0 0 12px' }}>
              Olá! 👋 Quer revender Kyrefh? É só clicar aqui embaixo que eu já te atendo agora no WhatsApp.
            </p>
            <a
...
export default function KyrefhV2Page() {
  ...
  return (
    <main style={{ fontFamily: 'var(--font-manrope), sans-serif', color: '#0a0a0a' }} className="min-h-screen">
      ...
      <Script id="clarity-kyrefh-v2" strategy="afterInteractive">
